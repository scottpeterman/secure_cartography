...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QListWidget,
                             ...
                             QMessageBox, QPlainTextEdit, QSplitter, QApplication)
...
class TopologyMergeWidget(QWidget):
    """Widget for merging multiple topology map files."""
    ...
    def update_buttons(self):
        ...
        self.preview_button.setEnabled(has_selection and len(self.file_list.selectedItems()) == 1)
...
def main():
    ...
    enhance_widget = TopologyMergeWidget()
