...
def collect_device_interfaces(device_data: Dict, credentials: Dict, verbose: bool) -> Dict:
    """Individual device interface collection function for multiprocessing"""
    ...
    template_mappings = {
        'arista': 'arista_eos_show_interfaces',
        'cisco': 'cisco_ios_show_interfaces',
        'nxos': 'cisco_nxos_show_interface'
    }
    ...
    try:
        ...
        logger.debug("Normalizing interface data")
...
class EnhancedInterfaceCollector:
    ...
    def collect_interfaces(self) -> Dict:
        ...
        self.logger.info(f"Starting interface collection for {total_devices} devices")
        start_time = time.time()
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='Enhanced Network Interface Collection Tool')
    parser.add_argument('--fingerprint', required=True, help='Path to fingerprint JSON file')
    parser.add_argument('--username', required=True, help='SSH username')
    parser.add_argument('--password', required=True, help='SSH password')
    parser.add_argument('--output', default='interface_results.json', help='Output file path')
    ...
    collector = EnhancedInterfaceCollector(
    ...
    results = collector.collect_interfaces()
    collector.save_results(results, args.output)

    print("\nInterface Collection Summary:")
